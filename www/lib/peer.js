...
var Reliable = require('reliable');
         console.log("reliable object creation : "+JSON.stringify(Reliable));
//console.log("Peer JS loading");
...
DataConnection.prototype._configureDataChannel = function() {
  ...
  this._dc.onopen = function() {
    ...
    self.emit('open');
         ...
         console.log("reliable"+util.supports.sctp)
  // Use the Reliable shim for non Firefox browsers
  if (!util.supports.sctp && this.reliable) {
         console.log("reliable if inside"+this._dc+ "debug"+util.debug);
...
function Peer(id, options) {
  ...
  // Ensure WebRTC supported
   console.log("av = "+util.supports.audioVideo +" supports = "+util.supports);
    console.log("json stringify : "+JSON.stringify(util.supports));
...
var util = {
  ...
  supports: (function() {
             console.log("Inside suppports funtion : ");
    if (typeof RTCPeerConnection === 'undefined') {
      return {};
    }
console.log("supports : settings values");
    var data = true;
    var audioVideo = true;
    ...
    if (data) {
      ...
      var reliablePC = new RTCPeerConnection(defaultConfig, {});
             console.log("reliablePC :::"+reliablePC);
      try {
        var reliableDC = reliablePC.createDataChannel('_PEERJSRELIABLETEST', {});
             console.log("reliableDC :::"+JSON.stringify(reliableDC));
             console.log("Before scrop value : "+sctp);
        //sctp = reliableDC.reliable;
             sctp = true;
             console.log("After scrop value : "+sctp);
      } catch (e) {
      }
      reliablePC.close();
    }
 ...
 * Author: @michellebu
 */
          console.log("Creating reliable function :");
